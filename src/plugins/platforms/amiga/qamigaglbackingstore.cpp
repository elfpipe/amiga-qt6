...
QAmigaGLBackingStore::QAmigaGLBackingStore(QWindow *window)
...
QPaintDevice *QAmigaGLBackingStore::paintDevice()
{
    return m_device;
}

void QAmigaGLBackingStore::flush(QWindow *window, const QRegion &region, const QPoint &offset)
{
    Q_UNUSED(region);
    Q_UNUSED(offset);
